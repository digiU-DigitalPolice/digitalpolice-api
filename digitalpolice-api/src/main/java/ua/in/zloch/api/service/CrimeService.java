...
public class CrimeService {
    ...
    public CrimeListDTO filterCrimes(CrimeSearchParameters filterParameters) {
        CrimeFilter filter = conversionService.convert(filterParameters, CrimeFilter.class);
